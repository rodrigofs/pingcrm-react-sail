  ...
  return (
    <div className="flex items-center w-full max-w-md mr-4">
      <div className="relative flex w-full bg-white rounded shadow">
        ...
        <input
          className="relative w-full px-6 py-3 rounded-r focus:outline-none focus:ring-1 focus:ring-indigo-400"
          autoComplete="off"
          type="text"
          name="search"
          value={values.search}
      ...
      <button
        onClick={reset}
        className="ml-3 text-sm border-gray-50 text-gray-600 hover:text-gray-700 focus:text-indigo-700 focus:outline-none"
        type="button"
      >
        Reset
      </button>
